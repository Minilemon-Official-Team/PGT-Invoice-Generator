...
const styles = StyleSheet.create({
  ...
  brandMeta: { fontSize: 9, color: "#374151", marginTop: 4 },
  docBadge: {
    paddingVertical: 6,
  ...
  smallText: { fontSize: 9, color: "#374151", marginTop: 4 },
  ...
  totalsValueNormal: { fontSize: 12, fontWeight: "normal", color: "#111827" },
      ...
      >
        ...
        {data.template === "STYLE_A" ? (
          ...
          <>
            ...
            <View style={styles.totals}>
              ...
              <View style={styles.totalsRow}>
                ...
                <Text style={styles.totalsValueNormal}>
          ...
          <>
            ...
            >
              ...
              >
                ...
                <View>
                  ...
                  <Text style={styles.brandMeta}>{data.brand.location}</Text>
                  <Text style={styles.brandMeta}>{data.brand.contact}</Text>
                </View>
              </View>
            ...
            <View style={{ marginTop: 8, marginBottom: 8 }}>
              ...
              <Text style={{ marginTop: 6 }}>{data.client?.name || "-"}</Text>
            </View>
            ...
            <View>
              ...
              >
                ...
                <Text
                  style={{ flex: 1, textAlign: "center", color: brandColor }}
                >
                  Jumlah
                </Text>
                <Text
                  style={{ flex: 2, textAlign: "right", color: brandColor }}
                >
                  Harga
                </Text>
                <Text
        ...
        {data.notes ? (
          <View style={{ marginTop: 20 }}>
            <Text style={[styles.notesTitle, { color: brandColor }]}>
              CATATAN
            </Text>
